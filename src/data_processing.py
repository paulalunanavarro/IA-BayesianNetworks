...
data['ResponseTime'] = pd.cut(data['ResponseTime'], bins=bins_response_time, labels=labels_response_time_en, right=False)
...
data['ResponseDuration'] = pd.cut(data['ResponseDuration'], bins=bins_response_duration, labels=labels_response_duration_en, right=False)
...
data['PeopleAffected'] = pd.cut(data['PeopleAffected'], bins=bins_people_affected, labels=labels_people_affected_en, right=False)
...
data['PeopleAssisted'] = pd.cut(data['PeopleAssisted'], bins=bins_people_assisted, labels=labels_people_assisted_en, right=False)
...
data['AgenciesInvolved'] = pd.cut(data['AgenciesInvolved'], bins=bins_agencies_involved, labels=labels_agencies_involved_en, right=False)
...
data['CoordinationScore'] = pd.cut(data['CoordinationScore'], bins=bins_coordination_score, labels=labels_coordination_score_en, right=False)
...
data['CommunicationScore'] = pd.cut(data['CommunicationScore'], bins=bins_communication_score, labels=labels_communication_score_en, right=False)
...
data['EconomicDamage'] = pd.cut(data['EconomicDamage'], bins=bins_economic_damage, labels=labels_economic_damage_en, right=False)
...
data['Casualties'] = pd.cut(data['Casualties'], bins=bins_casualties, labels=labels_casualties_en, right=False)
